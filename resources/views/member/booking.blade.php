@extends('member.layout') {{-- atau layout admin jika ada --}}
...
@endif  
            ...
            <h2 class="text-2xl font-bold text-center text-green-600 mb-6">Form Booking</h2>

            <form action="{{ route('member.booking.submit') }}" method="POST" class="space-y-4" id="formBooking">
                @csrf

                <!-- Nama -->
                <div>
                    <label class="block font-semibold mb-1">Nama Pemesan</label>
                    <input type="text" name="nama" class="w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-green-400 bg-gray-100" 
                ...
                <div>
                    ...
                    <input type="tel" name="whatsapp" class="w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-green-400 bg-gray-100" 
                        value="{{ Auth::check() ? Auth::user()->nowa : '' }}" readonly required>
                </div>

                <!-- Tanggal Booking -->
                <div>
                    <label class="block font-semibold mb-1">Tanggal Booking</label>
                    <input type="date" name="tanggal" class="w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-green-400"                         
                        required
                ...
                <div>
                    ...
                    <select id="lapangan" name="lapangan_id" class="w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-green-400" required>
                ...
                <div>
                    ...
                    <select id="jam_mulai" name="jam_mulai" class="w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-green-400" required>
                ...
                <div>
                    ...
                    <select id="jam_selesai" name="jam_selesai" class="w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-green-400" required>
                ...
                <div>
                    ...
                    <input type="text" id="durasi" name="durasi" class="w-full border rounded-lg p-2 bg-gray-100" readonly>
                </div>

                {{-- <!-- Tarif -->
                <div>
                    <label class="block font-semibold mb-1">Tarif</label>
                    <input type="text" id="tarif" name="tarif" class="w-full border rounded-lg p-2 bg-gray-100" readonly>
                </div> --}}
           ...
           class="w-full border rounded-lg p-2 bg-gray-100" readonly>
                ...
                <div class="text-center space-x-2">
                    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-lg mb-4">
                        ...
                        <p>Silakan isi data dengan benar dan lengkap. Data yang salah atau asal-asalan dapat menyebabkan booking ditolak.</p>
                    </div>

                    
                    <button type="button" id="btnSubmit" class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-full font-semibold shadow-lg transition">
                        <i class="fa-solid fa-paper-plane"></i> Kirim Booking
                    </button>
                    <button type="reset" id="btnBatal" class="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-full font-semibold shadow-lg transition">
